...
```bash
openclaw skills install ./skills/expense-audit --as expense-audit
openclaw skills install ./skills/procurement-fraud --as procurement-fraud
openclaw skills install ./skills/investigation-assistant --as investigation-assistant
```
